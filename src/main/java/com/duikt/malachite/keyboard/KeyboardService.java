package com.duikt.malachite.keyboard;
...
public class KeyboardService {
    ...
    public ReplyKeyboard getMainMenuKeyboard(Long chatId) {
        List<KeyboardRow> keyboardRows= new ArrayList<>();
         ...
         row1.add(localizationService.getLocalizationMessage(chatId, "menu.about"));

         KeyboardRow row2 = new KeyboardRow();
         row2.add(localizationService.getLocalizationMessage(chatId, "menu.language"));
